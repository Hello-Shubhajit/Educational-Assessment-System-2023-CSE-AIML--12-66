    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href=""><b>&nbsp;&nbsp;&nbsp; Educational Assessment System</b></a>
            </div>
            <!-- Top Menu Items -->
      ...
      <div class="modal fade" id="s_report" role="dialog">
                ...
                <div class="modal-content">
                    ...
                    <form action="rms.php?page=list_report" method="POST">
                      <label class="control-label col-sm-3" for="pd">College Year:</label>
                      <br><br>
                      <div class="col-sm-2">          
                ...
                <div class="modal-content">
                    <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                          <h4 class="modal-title">Select College Year</h4>
                        </div>
                    <div class="modal-body">
                    <div class="container">
                    <div class="form-group">
