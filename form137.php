...
<div style="margin-left:.5in;margin-right:.5in;margin-top:.1in;margin-bottom:.1in;line-height:1mm;">
		...
		<p><center><b>Educational Assessment System</b></center></p>
		...
		?>
			<tr>
				<td style="width:600px;font-size:12px">
					...
					<b style="font-size:13px;text-transform: uppercase;"><?php echo $row['FIRSTNAME']. " " . $row['LASTNAME']." " .  substr("$mid",0,1) . ""; ?></b>
					<br>
		...
		<td >
		<label style="font-size:12px">Clg.Yr.:&nbsp&nbsp&nbsp&nbsp&nbsp
	...
	for($c =  $num1;$c < 4; $c++){
		...
		<td >
		<label style="font-size:12px">Clg.Yr.:&nbsp&nbsp&nbsp&nbsp&nbsp</label>
		</td>
		</tr>
		</table>
		<table style="border-collapse:collapse">
