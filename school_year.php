          ...
          <h1 class="page-header">College Year</h1>
      <?php
       ...
       <div class="col-md-8 " id="s_page">
        ...
        <div class="panel-heading">
          <h3 class="panel-title">List of College Year</h3>
        </div> 
  ...
  <table id="students" class="table table-hover table-bordered">
    <thead>
      <tr>
        <th style="width:20%">College Year</th>
   ...
   var stats = $("#stats"+i).val();
    ...
    data = '<div class="form-group">'+
      ...
      <div class="row main">
        ...
        <h3 id="head">Add New College Year</h3>
          <form class="" method="post">
            <input type="hidden" id="id" name="id">
            <div class="form-group">
              <label for="sy" class="cols-sm-2 control-label">College Year</label>
              <div class="cols-sm-4">
