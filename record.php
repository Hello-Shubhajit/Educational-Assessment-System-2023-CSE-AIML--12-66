...
success:function(data)
{
   $("#fetch-feild").html(data);
    ...
    ?>
          ...
          <h1 class="page-header"><?php echo $row['FIRSTNAME']. ' ' . $row['MIDDLENAME']. ' ' . $row['LASTNAME'] ?></h1>
          <?php
    } mysqli_close($conn);
      ?>
      <div class="col-md-5">
 ...
 <?php
    ...
    <div class="col-md-12">
      ...
      <label style="font-size:6" for="">College</label>
      ...
      <label style="font-size:6" for="">Total number of years in college to date</label>
        <input type="text" style="width:290px;text-align:center" value="<?php echo $row["TOTAL_NO_OF_YEAR"] ?>" disabled>

      <label style="font-size:6" for="">College Duration</label>
